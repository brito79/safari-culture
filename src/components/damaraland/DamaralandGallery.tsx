      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        >
          ...
          <p className="text-xl text-black max-w-3xl mx-auto leading-relaxed">
            Discover the diverse beauty of Damaraland through images that capture 
            the essence of this ancient landscape where mountains meet desert and culture thrives.
          </p>
        </motion.div>
...
export default DamaralandGallery;