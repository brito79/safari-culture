      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
              ...
              <div className="space-y-4 text-stone-700 leading-relaxed">
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                  ...
                  <p className="text-amber-700 text-sm mt-2">
                    <strong>NOTE:</strong> Cultural activities available daily with local guide expertise.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="space-y-6 text-stone-700 text-lg leading-relaxed">
                ...
                <p>
                  ...
                  lights to discover desert adaptations.
                </p>
                <p>
                  ...
                  insights into traditional Damara lifestyles.
                </p>
              </div>
            </div>
        ...
        <div className="mb-20">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div className="space-y-6 text-stone-700 text-lg leading-relaxed">
              <p>
                The area is home to remarkable desert-adapted wildlife, including the endangered desert 
                black rhino and magnificent desert elephants that have developed unique survival strategies 
                in this arid environment.
              </p>
              <p>
                Smaller creatures such as bat-eared fox, caracal, brown hyena, and various antelope species 
                can be spotted during nature drives. The area&apos;s unique ecosystem supports fascinating 
                adaptations to extreme desert conditions.
              </p>
              <p>
                A surprisingly diverse array of insects, reptiles, and arachnids call this harsh 
                environment home. Night walks reveal scorpions, geckos, and other nocturnal creatures 
                that come alive after dark.
              </p>
              <p>
                At dusk the desert transforms as temperatures drop and nocturnal wildlife begins their 
                nightly activities under the brilliant star-filled Damaraland sky.
              </p>
            </div>
            <div className="space-y-4">
